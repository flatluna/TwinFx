...
public class DocumentIntelligenceService
{
    ...
    {
        // Try different number types based on actual DocumentField properties
        if (field.ValueNumber != null) return field.ValueNumber.Value;
        if (field.ValueInteger != null) return (double)field.ValueInteger.Value;
    ...
    {
        return field.ValueArray != null && field.ValueArray.Count > 0;
    }
    ...
    {
        return field.ValueArray ?? Array.Empty<DocumentField>();
    }
    ...
    {
        return field.ValueObject ?? new Dictionary<string, DocumentField>();
    }
    ...
    private static string GetFieldType(DocumentField field)
    {
        ...
        if (field.ValueNumber != null) return "Number";
        if (field.ValueInteger != null) return "Integer";
        ...
        if (field.ValueArray != null) return "Array";
        if (field.ValueObject != null) return "Object";
        return "Unknown";
    }
    ...
    private static string GetFieldValue(DocumentField field)
    {
        ...
        if (field.ValueNumber != null) return field.ValueNumber.Value.ToString("F2");
        if (field.ValueInteger != null) return field.ValueInteger.Value.ToString();
        if (field.ValueCurrency != null) 
        {
            // Handle CurrencyValue structure - check for Amount property first, then fallback
            try
            {
        ...
        if (field.ValueArray != null) return $"Array with {field.ValueArray.Count} items";
        if (field.ValueObject != null) return $"Object with {field.ValueObject.Count} fields";
