    ...
    public class PicturesFamilySearchIndex
    {
        ...
        public async Task<PicturesFamilyIndexResult> CreatePicturesFamilyIndexAsync()
        {
            try
            {
                ...
                // Define search fields based on PictureFamilyIndexContent schema
        ...
        public async Task<FotosAiSearchResponse> SearchFamilyPicturesAsync(PicturesFamilySearchQuery query)
        {
            try
            {
                if (!IsAvailable)
...
""";
        ...
        private async Task<string> ProcessSearchResultsAsync(List<PicturesFamilySearchResultItem> results, PicturesFamilySearchQuery query)
        {
            ...
            try
            {
                ...
                // Aquí podrías almacenar el análisis AI completo en algún lugar si es necesario
...
""";
    ...
    /// <summary>
    /// Consulta de búsqueda para fotos familiares con opciones configurables
    /// </summary>
    public class PicturesFamilySearchQuery
    {
        /// <summary>
        /// Texto de búsqueda
        /// </summary>
        ...
        /// <summary>
        /// ID del Twin para filtrar resultados
        /// </summary>
        ...
        /// <summary>
        /// Usar búsqueda vectorial con embeddings
        /// </summary>
        ...
        /// <summary>
        /// Usar búsqueda híbrida (combina vectorial y textual)
        /// </summary>
        public bool UseHybridSearch { get; set; } = false;

        /// <summary>
        /// Vector pre-calculado (opcional)
        /// </summary>
        public float[]? Vector { get; set; }

        /// <summary>
        /// Filtro por número mínimo de tokens
        /// </summary>
        public int? MinTokens { get; set; }

        /// <summary>
        /// Filtro por número máximo de tokens
        /// </summary>
