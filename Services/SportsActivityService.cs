...
namespace TwinFx.Services
{
    ...
    public class SportsActivityService
    {
        ...
        public SportsActivityService(ILogger<SportsActivityService> logger, IConfiguration configuration)
        {
            ...
            _sportsContainer = _database.GetContainer("TwinSports");
        ...
        /// </summary>
        public async Task<bool> CreateSportsActivityAsync(TwinFx.Models.SportsActivityData activityData)
        {
            try
            {
                var activityDict = activityData.ToDict();
                await _sportsContainer.CreateItemAsync(activityDict, new PartitionKey(activityData.TwinID));
        ...
        /// </summary>
        public async Task<List<TwinFx.Models.SportsActivityData>> GetSportsActivitiesByTwinIdAsync(string twinId)
        {
            try
            {
                ...
                var activities = new List<TwinFx.Models.SportsActivityData>();
                ...
                while (iterator.HasMoreResults)
                {
                    ...
                    foreach (var item in response)
                    {
                        try
                        {
                            var activity = TwinFx.Models.SportsActivityData.FromDict(item);
            ...
            catch (Exception ex)
            {
                ...
                return new List<TwinFx.Models.SportsActivityData>();
            }
        }
        ...
        /// </summary>
        public async Task<TwinFx.Models.SportsActivityData?> GetSportsActivityByIdAsync(string activityId, string twinId)
        {
            try
            {
                ...
                while (iterator.HasMoreResults)
                {
                    ...
                    {
                        var activity = TwinFx.Models.SportsActivityData.FromDict(activityDocument);
        ...
        /// </summary>
        public async Task<bool> UpdateSportsActivityAsync(TwinFx.Models.SportsActivityData activityData)
        {
            try
            {
                ...
                var activityDict = activityData.ToDict();
                await _sportsContainer.UpsertItemAsync(activityDict, new PartitionKey(activityData.TwinID));
        ...
        /// </summary>
        public async Task<List<TwinFx.Models.SportsActivityData>> GetSportsActivitiesByDateRangeAsync(string twinId, DateTime startDate, DateTime endDate)
        {
            try
            {
        ...
        /// </summary>
        public async Task<TwinFx.Models.SportsActivityStats> GetSportsActivityStatsAsync(string twinId, DateTime? startDate = null, DateTime? endDate = null)
        {
            try
            {
                ...
                var stats = new TwinFx.Models.SportsActivityStats();
            ...
            catch (Exception ex)
            {
                ...
                return new TwinFx.Models.SportsActivityStats();
            }
        }
    }
}