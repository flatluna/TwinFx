...
namespace TwinFx.Agents
{
    public class FamilyFotosAgent
    {
        ...
        public async Task<ImageAI> AnalyzePhotoAsync(string sasUrl, PhotoFormData photoContext, string UserDescription)
        {
            ...
            try
            {
                ...
                var analysisPrompt = CreatePhotoAnalysisPrompt(photoContext, UserDescription);
